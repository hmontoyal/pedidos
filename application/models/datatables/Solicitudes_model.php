...
protected $column_search = array('id_request','rut','date', 'state', 'nombre_cliente', 'iscommercial', 'commercial_name', 'address', 'email', 'phone', 'total_pedido'); //set column field database for datatable searchable 
