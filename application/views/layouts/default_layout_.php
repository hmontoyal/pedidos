            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard fa-fw"></i> Generar Pedidos de Productos</a>
                        </li>
                          ...
                          <li>
                            <a href="<?php echo base_url('solicitudes'); ?>"><i class="fa fa-shopping-cart fa-fw"></i> Administrar Pedidos</a>
                        </li>
                         <li>
                            <a href="<?php echo base_url('users/nuevo'); ?>"><i class="fa fa-dashboard fa-user-plus"></i> Administrar Usuarios</a>
                        </li>
