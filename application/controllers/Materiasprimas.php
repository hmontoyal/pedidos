...
class Materiasprimas extends MY_Controller
{
    ...
    public function nuevo(){
       ...
       $this->template->set('page_header', 'Crear Nuevo Usuario');
       $this->template->set('css', $css);
       $this->template->set('scripts', $scripts);
       $this->template->load('default_layout', 'contents' , 'users/index');
...
public function perfil(){
		if($this->require_min_level(EJECUTIVE_LEVEL)){
		   $this->template->set('title', 'Información de Perfil');
		   $this->template->set('page_header', 'Información de Perfil');
