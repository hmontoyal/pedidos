                  ...
                  $list = $this->sweets->get_datatables();
					        ...
					        foreach ($list as $fila) {
					          //var_dump($tareas);
					            ...
					            $row[] = '<button class="btn btn-sm btn-warning item-edit" data-id="'.$fila->id.'">Editar</button> <button class="btn btn-sm btn-danger item-delete" data-id="'.$fila->id.'">Eliminar</button>';
